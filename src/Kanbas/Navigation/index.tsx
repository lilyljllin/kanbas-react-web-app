...
export default function KanbasNavigation() {
  ...
  const links = [
    ...
    { label: "History", path: "/Kanbas/History", icon: FaRegClock},
    {label: "Studio", path: "/Kanbas/Studio", icon: FaComputer},
    {label: "Help", path: "/Kanbas/Help", icon: IoIosHelpCircleOutline},
