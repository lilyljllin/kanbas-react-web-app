        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Stir enough to moisten the flour mixture</li>
                    <li>Heat a griddle or large nonstick pan over medium heat</li>
                    <li>Ladle the batter onto the skillet</li>
                    <li>Cook unti the top surface bubbles and is dotted with holes</li>
            ...
            <div id="wd-forms">
                ...
                <h4>My GitHub Reprository</h4>
                <a href="https://github.com/lilyljllin/kanbas-react-web-app.git">github</a>
            </div>
